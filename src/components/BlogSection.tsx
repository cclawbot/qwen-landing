...
const categoryColors: Record<BlogPost["category"], string> = {
  "Product Update": "bg-blue-600/20 text-blue-400",
  Tutorial: "bg-green-600/20 text-green-400",
  Industry: "bg-purple-600/20 text-purple-400",
};
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogPosts.map((post) => (
            <article
              key={post.id}
              className="p-6 rounded-3xl border backdrop-blur-xl transition-all duration-300 cursor-pointer hover:scale-[1.02] hover:shadow-xl"
              style={{ 
