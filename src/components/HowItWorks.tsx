export default function HowItWorks() {
  return (
    <section className="py-24" style={{ backgroundColor: 'var(--card-bg)' }}>
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Step 1 */}
          <div className="text-center p-8 rounded-3xl border backdrop-blur-xl" style={{ backgroundColor: 'var(--bg-primary)', borderColor: 'var(--border-color)' }}>
